        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-9">
            <div class="text__block">
			 ...
			 <h5 class="text__block-title">FERRO NICKEL MOLY</h5>      
			 <img src="uploads/products/6.jpg" class="img-responsive" alt="Refracast Metallurgicals Pvt.Ltd." title="Refracast Metallurgicals Pvt.Ltd.">
