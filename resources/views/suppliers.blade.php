...
<!-- what we buy info -->
<section class="container what_we_buy textinfo ">
    <p class=" text-green fs-3 fw-bold pleft">WHAT WE BUY</p>
    <!-- <p class="h1 text-center text-opacity mt-2">The Visionary Drive of Mr. Arnab Roy</p> -->
     <p class="fs-5 pleft">We are actively seeking material containing.</p>
     <p class="fs-5 pleft">Nickel, Cobalt, Molybdenum, Vanadium, Tungsten, and Zinc in the following forms:</p>
     <ul class="uleft">
