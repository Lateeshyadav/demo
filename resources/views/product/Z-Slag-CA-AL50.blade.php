...
<div class="container-fluid p-5  text-white text-center product-top">
    <div class="row">
        <div class="col-md-4 col-12">
            <img src="{{asset('product_img/Z-SlagCA-AL50.jpg')}}" alt="" class="img">
        </div>
        <div class="col-md-8 col-12">
          <div class="productname">
            <h1 class="darkgreen fontf">Z-SLAG CA-AL50</h1>
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <table class="table border table-hover">
          ...
          <h5 class="darkgreen fontf">Z-Slag CA-AL50</h5>
          <thead>
            {{-- <tr>
              <th scope="col">#</th>
      ...
      <div class="col-sm-6">
        <h3 class="darkgreen fontf">ADDITOIN OF Z-Slag CA-AL50 :</h3>
        <h5 class="darkgreen fontf">APPLICATION : (How to use) </h5>
        <ul>
          <li class="textjustify p"> Once the liquid steel metal is ready for tapping and empty ladle is placed add 2 to 5kg of Z-Slag CA-AL50 per ton of liquid steel in the empty ladle.</li>
        ...
        <h3 class="darkgreen fontf">BENEFITES OF Z-Slag CA-AL50 : </h3>
        <ul>
          ...
          <li class="textjustify p"> Faster inclusion removal and clean liquid steel.</li>
          <li class="textjustify p"> Helps prevent refectory lining Life as the basicity of slag is improved.</li>
          <li class="textjustify p"> Consistent chemistry of the steelmaking slag.</li>
          ...
          <li class="textjustify p"> An effective fluid sink that absorbs inclusions from steel.</li>
          <li class="textjustify p"> Fast and better recovery of steel as well as alloys.</li>
          <li class="textjustify p"> Z-Slag CA~AL50 works as the catalyst to prevent inclusion, Phosphorus and Sulphur reversal from slag to steel.</li>
