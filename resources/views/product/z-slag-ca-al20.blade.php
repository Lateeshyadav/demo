...
@extends('product')
@section('title','Z-SLAG-CA-AL20')

@section('product')
{{-- <a href="{{asset('refmet/uploads/upload_images/1706096833T_BROCHURE-02.jpg')}}" download="1706096833T_BROCHURE-02.jpg" class=" text-decoration-none btn btn-outline-success"><i class="fa-solid fa-download m-1"></i>Brochure</a> --}}
