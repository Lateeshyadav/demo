    ...
    <div class="row bg-white footer-row-second" style="border-radius: 50px 50px 0 0;">
        ...
        <div class="col-md-4 ps-5">
            ...
            <ul>
                ...
                <li class="footer-row-second-li"><a class="footer-row-second-a" href="">Contact</a></li>
        ...
        <div class="col-md-4 ">
            ...
            <ul>
                ...
                <li class="footer-row-second-li"><a class="footer-row-second-a" href="">Z-Slag CA-AL20</a></li>
                <li class="footer-row-second-li"><a class="footer-row-second-a" href="">SLAG KILL 100</a></li>
                <li class="footer-row-second-li"><a class="footer-row-second-a" href="">FERRO NICKEL</a></li>
                <li class="footer-row-second-li"><a class="footer-row-second-a" href="">FERRO NICKEL MOL</a></li>
            </ul>
        </div>
        <hr class="mt-5">
    </div>
