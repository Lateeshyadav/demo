        ...
        <div class="col-md-12 green position-relative main-box" style="">
            <div class="box mt-5 position-absolute translate-middle" style="">
                ...
                <div class="text-center">
                  <h2 class="text-center mt-3 fw-bold text-green textinfo-h3 ">Refracast Metallurgicals Pvt.Ltd.</h2>
              </div>
            </div>
        </div>
    </div>
...
<section class="container textinfo ">
    <p class="h1 fw-bold text-green textinfo-h1 aleft">ABOUT US</p>
    <!-- <p class="h1 text-center text-opacity mt-2">The Visionary Drive of Mr. Arnab Roy</p> -->
    <p class="h4  textjustify textinfo-h1-p mb-4">At <strong>Refracast Metallurgicals Pvt Ltd (RMPL)</strong>, we pride ourselves on being pioneers in the field of spent
