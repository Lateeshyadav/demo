...
<section class="container textinfo ">
    ...
    <p class="h4  textjustify textinfo-h1-p ">At Refracast Metallurgicals Pvt Ltd (RMPL), we pride ourselves on being pioneers in the field of spent 
    ...
    <p class="h4 textjustify textinfo-h1-p">RMPL has carved a niche as a leader, specializing in recycling complex spent catalysts and developing cutting-edge solutions for the steel-making sector. Our dedication to research and development has allowed us to handle the most intricate catalysts, positioning us at the forefront of sustainable recycling practices. Our unique zero-waste technologies have set new industry standards, reinforcing our commitment to environmental stewardship.
    </p>
    <p class="h4 textjustify textinfo-h1-p">Our extensive expertise spans across multiple metallurgical processes, and we are particularly proud of our innovations that have transformed the Indian steel-making industry. Through the creation of 
    ...
    <p class="h4 textjustify textinfo-h1-p">With a history marked by groundbreaking achievements and a forward-thinking approach, RMPL is 
