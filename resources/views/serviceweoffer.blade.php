    ...
    <div class="row">
        <div class="col-md-12 green position-relative main-box" style="">
            <div class="box mt-5 position-absolute translate-middle" style="">
                <img src="{{asset('image/what-services-we-offer.png')}}" alt="" class="img-fluid imgsize">
    ...
    <!-- <p class="h1 text-center text-opacity mt-2">The Visionary Drive of Mr. Arnab Roy</p> -->
     ...
     <ul class="uleft">
        ...
        <ul style="list-style: none;">
            ...
            <li class="textinfo-h1-p"><img src="https://icons.iconarchive.com/icons/praveen/minimal-outline/128/next-2-icon.png" width="35" height="35">Reduce ladle refining furnace (LRF) refining time.</li>
            <li class="textinfo-h1-p"><img src="https://icons.iconarchive.com/icons/praveen/minimal-outline/128/next-2-icon.png" width="35" height="35">Enhance desulfurization processes, applicable to both LRF and induction furnace setups.</li>
            <li class="textinfo-h1-p"><img src="https://icons.iconarchive.com/icons/praveen/minimal-outline/128/next-2-icon.png" width="35" height="35">Improve iron recovery by reducing FeO content in slag.</li>
            <li class="textinfo-h1-p"><img src="https://icons.iconarchive.com/icons/praveen/minimal-outline/128/next-2-icon.png" width="35" height="35">Provide a full range of products tailored for both primary and secondary steel plants.</li>
        </ul>
        </li>
